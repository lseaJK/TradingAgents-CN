...
DASHSCOPE_OPENAI_MODELS = {
    ...
    "qwen3-235b-a22b-thinking-2507": {
        "description": "通义千问3-235B-A22B 思考模式 - 超大参数推理模型，专注复杂推理任务",
        ...
        "supports_function_calling": True,
        "recommended_for": ["数学推理", "代码生成", "逻辑分析", "复杂问题求解"]
    },
    "qwen3-235b-a22b-instruct-2507": {
        "description": "通义千问3-235B-A22B 非思考模式 - 通用大模型，平衡性能与效率",
        "context_length": 131072,
        ...
        "supports_function_calling": True,
        "recommended_for": ["通用对话", "内容创作", "知识问答", "文本处理"]
    }
}
